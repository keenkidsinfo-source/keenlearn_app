...
const builds = [
  // ── G1-2 Week 1: Cable Car ───────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      {
        emoji: '📈',
        title: 'Round 3 — maximum + share out!',
        text: 'Keep adding rocks one at a time. Test after each. When the cup STOPS again — too heavy — the count before it stopped is your MAXIMUM. Write it on the chart. Then share out: "My minimum was ___ rocks. My maximum was ___ rocks!"',
        tip: 'Real cable cars in San Francisco, ski gondolas, and aerial tramways all use the same pulley principle as your cup today!',
      },
    ],
  },
