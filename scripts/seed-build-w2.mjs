    ...
    steps: [
      {
        emoji: '⚖️',
        title: 'Meet your materials',
        text: 'You have: 2 popsicle sticks, 1 cardstock cylinder base (pre-rolled, or roll it yourself), clay, 6 string pieces (15 cm each, 3 per pan), 2 cardstock circle pans, masking tape, small objects to weigh, and a pen. Your scale must be sensitive enough to detect a single paperclip!',
        tip: 'Plus: coins, rocks, erasers, nuts, buttons. Also a pen to mark the true centre of the beam.',
      },
      {
        emoji: '🏗️',
        title: 'Roll the base + fill with clay',
        text: 'Roll the cardstock into a cylinder about 5 cm wide. Tape the seam firmly along the full length. Fill the BOTTOM HALF of the cylinder with clay — press it in firmly. The heavy clay base stops the whole scale from tipping over when you add weights.',
        tip: 'Roll from the short edge for a narrower, more stable cylinder. Tape the full seam length. Clay fills at least half the base.',
      },
      {
        emoji: '🪵',
        title: 'Add the vertical post',
        text: 'Push one popsicle stick VERTICALLY into the clay through the top of the cylinder. Push it in deep — at least 3 cm. It should stand straight without any wobble. Look from the SIDE and the FRONT: must be exactly vertical. Tape around the base of the stick for extra grip.',
        tip: 'The post must be exactly vertical (90 degrees). A tilted post means your scale will always read false.',
      },
      {
        emoji: '📏',
        title: 'Find the TRUE centre of the beam',
        text: 'Take the second popsicle stick (horizontal beam). Balance it on your fingertip. Slide your finger until it hangs perfectly level. That spot is the TRUE centre — mark it with a clear pen dot. The wood is not perfectly uniform so the real balance point may not be the geometric middle.',
      ...
      },
      {
        ...
        text: 'Lay the horizontal beam across the top of the vertical post AT the pen-dot centre. Make a tiny tape loop to keep the beam on the post — just enough to hold it but still allow it to swing. Test: flick one end — it should swing and return to level. If it does not swing freely, loosen the tape loop slightly.',
        tip: 'If the beam does NOT swing freely, the tape loop is too tight. Loosen it. The beam MUST pivot or your scale will not work.',
      },
      {
        emoji: '🧵',
