...
async function buildG12() {
  ...
  const project = {
    targets: [
      ...
      makeSprite('Pikachu',  makeCostume(pikaMd5, 'pikachu',  60, 60),  -60, -100, 60, 1),
      makeSprite('PokeBall', makeCostume(ballMd5, 'pokeball', 40, 40),   60, -100, 50, 2),
...
async function buildG34() {
  ...
  const project = {
    targets: [
      ...
      makeSprite('Pikachu',  makeCostume(pikaMd5,  'pikachu',  60, 60), -60, -120, 55, 1),
      makeSprite('PokeBall', makeCostume(ballMd5,  'pokeball', 40, 40),  60, -120, 50, 2),
