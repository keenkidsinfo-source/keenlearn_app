...
const wellPulleyDeck: TheoryDeck = {
  ...
  slides: [
    ...
    },
    {
      ...
      headline: 'Crank = wheel. Skewer = axle. Every turn winds the string — bucket goes up.',
      bullets: [
        '**Crank handle** (wheel) → **wooden skewer** (axle) → **string winds** → **bucket rises**.',
        'Longer crank = more string wound per turn = **fewer cranks to lift the bucket**.',
        'Your job: count the cranks, then improve your design to use fewer!',
      ],
      vocab: { word: 'Rotation', definition: 'Spinning around a fixed center point' },
      tryThis: 'Predict: how many cranks will it take to lift the bucket all the way up?',
    },
    {
      emoji: '💪',
      color: 'purple',
      title: 'Mechanical Advantage',
      headline: 'Longer crank = bigger MA = less force needed. Trade effort for distance.',
      bullets: [
        '**MA = crank radius ÷ axle radius** (skewer ≈ 0.5 cm)',
        'Crank 2 cm from center → MA = 4 · Crank 5 cm from center → **MA = 10**',
        'MA of 10 means lifting 100 g takes only **10 g of hand force!**',
      ],
      vocab: { word: 'Mechanical Advantage', definition: 'How many times a machine multiplies your force' },
      tryThis: 'Your skewer radius is ~0.5 cm. Measure your crank and calculate your MA!',
    },
    {
      emoji: '🌍',
      color: 'red',
