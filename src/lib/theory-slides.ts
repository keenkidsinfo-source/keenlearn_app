...
const marbleRunG34Deck: TheoryDeck = {
  ...
  slides: [
    ...
    },
    {
      emoji: '🏆',
      color: 'green',
      title: 'Engineer for SLOW',
      headline: 'Flatter + rougher + more turns + more sections = slowest time. Slowest winner wins!',
      bullets: [
        '**Flatter angles** → less gravity along slope → marble barely moves.',
        '**More direction changes** → more energy lost at each turn.',
        '**Corrugated cardboard** → more friction → marble loses more speed.',
        '**More sections** → more track contact → more friction → more time.',
        'Vocab: **GRAVITY · FRICTION · MOMENTUM · KINETIC ENERGY · VELOCITY · ANGLE**',
      ],
      tryThis: 'After you time your run — what ONE change would make it SLOWER? Predict it, then test it.',
      speakerNotes: [
        '"Making something go slower on purpose is HARDER than making it fast. You need real precision — too slow and it stops. Just slow enough and you win."',
        '"Your four levers: flatter angles, more sections, more friction surfaces, tighter curves. Use all of them."',
        '"Real world: speed limiters on cars, drag chutes on dragsters, water resistance — all engineering to control and slow motion. Time to plan — arrows on your base before you tape anything. Go!"',
      ],
    },
  ],
}
  ...
  slides: [
    {
      ...
      color: 'orange',
      title: 'What Did We Build?',
      headline: 'A fan that makes WIND — no battery needed!',
      bullets: [
        'Fan blade + skewer + string + cup.',
        'Pull the string → fan spins → makes WIND! 💨',
      ],
      speakerNotes: [
        'Hold up a finished demo fan. "No motor, no battery — just a string and paper."',
        'Pull slowly. "See? The string makes it spin. The spin makes wind!"',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Our fan blades push air to make wind.',
      ],
      vocab: { word: 'Wind', definition: 'Air that is moving' },
      tryThis: 'Wave your hand fast in front of your face — you just made wind!',
      speakerNotes: [
        '"Air is all around us — but we can\'t feel it when it\'s still."',
        '"Wave your hand! Feel that? You moved air. You made wind!"',
        '"Our fan does the same thing, but faster."',
      ],
    },
    {
      emoji: '🎁',
      ...
      headline: 'Winding the string STORES energy — like a wind-up toy!',
      bullets: [
        'The more you wind, the more energy stored.',
        "It's waiting... ready to go!",
      ],
      vocab: { word: 'Stored Energy', definition: 'Energy saved up and ready to use' },
      tryThis: 'Wind the string tight. Can you feel it trying to spin back?',
      speakerNotes: [
        '"Like a wind-up toy car — more wind = more energy stored."',
        '"Our string does the same thing. Winding = storing energy."',
      ],
    },
    {
      emoji: '🚀',
      color: 'red',
      title: 'Release the Energy!',
      headline: 'Pull the string → energy comes out → fan SPINS → WIND!',
      bullets: [
        'Pull → skewer spins → fan spins → pushes air → wind!',
        'Pull FASTER = more wind!',
      ],
      tryThis: 'Try slow vs fast. Which makes more wind?',
      speakerNotes: [
        '"Say it with me: pull → spin → push air → wind!"',
        '"Pull fast, pull slow. What changes?"',
      ],
    },
    {
      emoji: '🌍',
      color: 'purple',
      title: 'Fans Everywhere!',
      headline: 'People have used spinning fans for thousands of years!',
      bullets: [
        '🪭 Hand fans · 💨 Electric fans · 🌬️ Wind turbines · ✈️ Propellers',
        'All use the same idea: spinning blades move air!',
      ],
      tryThis: 'Can you think of another spinning thing that moves air?',
      speakerNotes: [
        '"3,000 years ago people used hand fans in China and Japan!"',
        '"Wind turbines go backwards — wind spins the fan, makes electricity."',
        '"One idea: spinning = moving air. It\'s everywhere!"',
      ],
    },
    {
      emoji: '🏆',
      ...
      headline: 'Wind string → store energy → pull → spin → WIND!',
      bullets: [
        '💨 Wind = moving air.',
        '🎁 Winding = storing energy. 🚀 Pulling = releasing it.',
      ],
      tryThis: 'Tell the person next to you: "I made wind by ___."',
      speakerNotes: [
        '"No battery, no motor — just a string and energy YOU put in."',
        '"That\'s engineering — store energy, release it, make something happen!"',
      ],
    },
    {
      emoji: '🙋',
      ...
      bullets: [
        ...
        "❓ What does winding do? → Stores energy!  ❓ What makes it spin? → Pulling the string!",
      ],
      tryThis: "Ready to build and make real wind? Let's GO! 🌀",
      speakerNotes: [
        '"Quick fire — I ask, you shout!"',
        '"What is wind? / What does winding do? / What makes it spin?"',
        '"You\'ve got the science. Materials are out — GO!"',
      ],
    },
  ],
}
  ...
  slides: [
    {
      ...
      bullets: [
        'A **propeller** is a spinning fan with curved blades that pushes against air or water to move something forward.',
        'When the propeller spins fast, the curved blades slice through the air and shove it backward.',
        'Skewer = **axle** (spinning shaft) · Wound string = **stored potential energy**',
      ],
    ...
    },
    {
      ...
      headline: 'Push air backward → a force called THRUST shoots forward.',
      bullets: [
        'Propeller blades shove air backward → **thrust** shoots the vehicle forward.',
        '**Thrust** = the force created by pushing air (or water) in one direction.',
        'The faster it spins, the more air pushed per second → more thrust.',
      ],
