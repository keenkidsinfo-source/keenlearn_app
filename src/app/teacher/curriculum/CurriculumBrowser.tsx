...
interface Props {
  weeks: Week[]
  assignedMap: Record<string, string>   // curriculumId → weekStartDate
  classroomId: string
}
...
export function CurriculumBrowser({ weeks, assignedMap, classroomId }: Props) {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-4">
        Click <strong>Assign</strong> to schedule a week for your class. Students will see it in their dashboard.
      </p>
